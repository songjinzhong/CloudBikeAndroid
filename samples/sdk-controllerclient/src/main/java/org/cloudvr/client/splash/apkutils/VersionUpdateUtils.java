package org.cloudvr.client.splash.apkutils;
...
public class VersionUpdateUtils {
    ...
    private void showUpdateDialog(final VersionEntity versionEntity){
        ...
        builder.setIcon(R.drawable.splash_bg);
    ...
    protected void downloadNewApk(String url){
        ApkDownloader downloader=new ApkDownloader();///mnt/sdcard/
        downloader.download(url, Environment.getExternalStorageDirectory()+"CloudVRClient2.0.apk", new ApkDownloader.MyCallBack() {
            @Override
    ...
    public void getCloudVersion(){
        try{
            ...
            HttpGet httpGet=new HttpGet("http://172.28.49.70:8080/updateinfo.html");
